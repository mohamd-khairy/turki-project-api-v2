...
//      }
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                'Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJhY2NvdW50SWQiOiJmZDIzZDdmYi1hNTA4LTQ4MzgtOGVhNC00NTQxNjlhNjY3NTkiLCJ0eXBlIjoibWVyY2hhbnQiLCJzYWx0IjoiZDIwMzFlYTBiODAyZDQ5ZGYyYjNhNTgwOTU5NjI5M2YiLCJpYXQiOjE2NDkzMjYzMzEsImlzcyI6IlRhbWFyYSJ9.mOsgSpYpVopPGsrAH5R8m00ETSVWLJkOj3EPkfvVmdU7OxXi6AWUrypd7Sx4eo2J7jFI9a1UoYupZWSgrRTuupeCF6tQ7NbtYfASbmIgPEcfn0gGoC6im8VF0iorEDZJKnbXbviMuoKNcwj2LYvYZsZfQZEHokY68Gh5BZGeBjki4YbCyctFy_r4xA7lTZts3dZnqJZgML47of2x17FIZDV7z1wkcqiv9IWNMALwZUd5b9IXxs7PnTgsNE3Ul0qjWuhKl4sDvTC-NNVpbvcQlreoWbEaR9-8bW3_R41tnfihKwAMGwVjHqVNcpz550GEL-FQlc7Wxa9XGrgR4ZC6ew'
            ),
        ));
 ...
 public function checkoutTamaratest($customer, $address, $order, $paymentType, $country, $instalments = null)
    ...
    public function orderDetails($order)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://api.tamara.co/merchants/orders/reference-id/' . $order,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
...
//         }
    ...
    public function capturedOrder($order, $country){
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://api.tamara.co/payments/capture',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => '',
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 0,
